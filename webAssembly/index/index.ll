; ModuleID = 'index.c'
source_filename = "index.c"
target datalayout = "e-m:o-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-apple-macosx10.15.0"

@str = private unnamed_addr constant [36 x i8] c"from douban's hello, NanRenBan!!!! \00", align 1

; Function Attrs: nounwind ssp uwtable
define i32 @main() local_unnamed_addr #0 {
  %1 = tail call i32 @puts(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @str, i64 0, i64 0))
  ret i32 0
}
